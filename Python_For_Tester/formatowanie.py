...
print(f"Liczba pi to {moje_pi}, co można skrócić do >>>{moje_pi:.4f}<<<")  # Zwykłe zaokrąglenie do 4 cyfr po przecinku
print(f"Odchyłka pomiarowa wynosi >>>{odchylka:20.4f}<<<") # Szerokość 20 znaków + rozszerzenie po przecinku
...
print(f"Liczba w systemie dziesiętnym: {x_dec}, ta sama liczba binarnie:{x_dec:b} oraz heksadecymalnie: {x_dec:X}")
